...
# GShay,6.6.2021,Rewrote print_current_list_items
# GShay,6.8.2021,Added print_current_list_person_items for test harness
# ---------------------------------------------------------- #
...
class EmployeeIO:
    ...
    @staticmethod
    def print_current_list_person_items(list_of_rows: list):
